...
Pod::Spec.new do |spec|
 ...
 # spec.pod_target_xcconfig = { 'VALID_ARCHS[sdk=iphonesimulator*]' => ' ','GENERATE_INFOPLIST_FILE' => 'YES' } 
  ...
  spec.author             = { "袁石" => "yuans@polysoft.com.cn" }
  # Or just: spec.author    = "袁石"
  # spec.authors            = { "袁石" => "yuans@polysoft.com.cn" }
  # spec.social_media_url   = "https://twitter.com/袁石"
  ...
  spec.source       = { :git => "https://github.com/StoneYuan/cocoapodsTest.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "cocoaDemo/Headers/*{.h}"
